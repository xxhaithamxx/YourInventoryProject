...
#include "QuestItems.generated.h"

USTRUCT(BlueprintType)
struct FQuestItems : public FInventoryItems
{
	GENERATED_USTRUCT_BODY()

	FQuestItems()
	{
		ItemType = EItemTypes::EQuest;
		MaxStack = 20;
	}
...
public:
	FORCEINLINE int32 GetQuestID() const { return QuestID; }
	FORCEINLINE virtual int32 GetMaxStack() override { return MaxStack; }
	virtual FQuestItems* GetQuestItems()  override {return this;}
